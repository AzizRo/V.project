            ...
            <div class="form">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 align-items-left text-left">
                        <p class="pt-3 " style="font-size: 24px;   font-weight: bold;  color: #036A3B; ">  الفرصة التطوعية </p>
                    </div>
                </div>
                <!-- Second row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder" name="Name" value="{{$Info->Name}}" type="text" placeholder="الاسم المقترح للفكرة التطوعية*" required>
                    </div>
                </div>
                <!-- Third row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder"  name="Description" value="{{$Info->Description}}" placeholder="شرح موجز عن الفكرة التطوعية*" maxlength="200" style="resize: none; height: 150px;">
                    </div>
                </div>
                <!-- Four row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder" name="Goals" value="{{$Info->Goals}}" placeholder="الأهداف التي تحققها الفرصة التطوعية*" style="resize: none; height: 150px;" maxlength="50" required="">
                    </div>
                </div>
                <!-- Fifith row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder" name="Targeted" value="{{$Info->Targeted}}" type="text" placeholder="المستفيدين من الفكرة التطوعية">
                    </div>
                </div>
                <!-- Sixth row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder" name="Volunteernum" value="{{$Info->Volunteernum}}" type="text" placeholder="عدد المنتسبين في العمل التطوعي">
                    </div>
                </div>
                <!-- seventh row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder" name="Period" value="{{$Info->Period}}" type="text" placeholder="المدة المقترحة للفكرة التطوعية">
                    </div>
                </div>
                <!-- eighth row -->
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="update_input with_placeholder" name="Communication" value="{{$Info->Communication}}" type="text" placeholder="وسيلة تواصل">
                    </div>
                </div>
                ...
                <div class="row">
                    <!--First column-->
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <select required="" id="Gender" name="Gender" value="{{$Info->Gender}}" class="form-control update_input with_select">
                    ...
                    <!--Second column -->
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <select required="" id="inputState" name="SpecializeId" value="{{$Info->SpecializeId}}"class="form-control update_input with_select">
                ...
                <div class="row">
                    <!--First column-->
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <select required="" id="inputState" name="LocationId" value="{{$Info->LocationId}}" class="form-control update_input with_select">
                    ...
                    <!--Second column -->
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <select required="" id="inputState" name="FieldId" value="{{$Info->FieldId}}" class="form-control update_input with_select">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <button type="submit" onclick="submitIdeaForm()" class="save_btn"><a href="{{route('admin')}}">عوده الى الصفحة الرئيسيه</a></button>
                    </div>
                </div>
            </div>
