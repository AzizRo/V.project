            ...
            <div class="form">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 align-items-left text-left">
                        <p class="pt-3 " style="font-size: 24px;   font-weight: bold;  color: #036A3B; "> {{ $Title }} الفرصة التطوعية </p>
                    </div>
                </div>
                <!-- Second row -->
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <button type="submit" onclick="submitIdeaForm()" class="save_btn">تحديث</button>
                    </div>
                </div>
            </div>
        </div>
