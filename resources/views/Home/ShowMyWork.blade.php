        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div style="background: linear-gradient(rgba(0,19,11,0.3), rgba(0,19,11,0.3)),url('/img/NajranLogoBig6.jpeg');" class="background_image text-center">
                    ...
                    <!--Show Volunteers Link  -->
                    <p class="details_title title_font">
                        <a   href="/Volunteers/show/{{{$work->WorkID}}}/{{$work->Name}}/{{$work->StartDate}}/{{$work->EndDate}}/{{$work->volunteer_hours}}/{{$work->first_name}}/{{$work->middle_name}}/{{$work->family_name}}"  style="    background-color: transparent;border-radius: 6px;color: white;border: none;">المتطوعين المسجلين في الفرصة</a>
